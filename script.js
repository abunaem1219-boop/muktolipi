...
window.renderStorySkeletons = function() {
    ...
    for(let i=0; i<4; i++) {
        html += `
        <div class="story-card skeleton" style="background: var(--shimmer-bg); position: relative; border: 1px solid var(--border-color); background-size: 200% 100%; animation: shimmer 1.5s infinite linear;">
            <!-- Avatar Ring Placeholder -->
            <div style="position: absolute; top: 10px; left: 10px; width: 34px; height: 34px; border-radius: 50%; background: rgba(255, 255, 255, 0.12); box-shadow: 0 0 0 2px rgba(255,255,255,0.05);"></div>
            <!-- Name Strip Placeholder -->
            <div style="position: absolute; bottom: 10px; left: 10px; width: 65%; height: 10px; border-radius: 4px; background: rgba(255, 255, 255, 0.12);"></div>
        </div>`;
    }
